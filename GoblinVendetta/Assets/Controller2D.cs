...
public class Controller2D : MonoBehaviour {
	...
	{
		globalVariable.guitext.text = transform.GetComponent<PlayerState>().stats.description;
		flying = true;
		yield return new WaitForSeconds(5);

		while (transform.position.x < globalVariable.landingPosition.x - 10) {
			float y;
